...
Public Class frmUpdateSO
    ...
    Private Sub BwSQ_RunWorkerCompleted(sender As Object, e As RunWorkerCompletedEventArgs) Handles BwSQ.RunWorkerCompleted
        ...
        Else
            If Label3.Text <> "Status: N/A" Then
                ...
                frmSQItem.Label1.Text = "Sales Order Item"
    ...
    Private Sub frmUpdateSO_FormClosing(sender As Object, e As FormClosingEventArgs) Handles Me.FormClosing
        For i As Integer = 0 To frmSQItem.TabControl1.TabCount - 1
            MDINItem(frmSQItem.TabControl1.TabPages(i).Tag) = Nothing
        Next
    ...
    Private Sub ToolStripButton1_Click(sender As Object, e As EventArgs) Handles ToolStripButton1.Click
        ...
        If slot > 0 Then
            ...
            Catch ex As Exception
                CloseConn(slot)
                NotifyMsgBox("s", "Sales order")
            End Try
        Else
            NotifyMsgBox("ps", "Sales order")
        End If
    End Sub
    ...
    Private Sub frmUpdateSO_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        If My.Settings.Lco = "All" Then
            Me.BackColor = Color.OliveDrab
            Me.Text = "Administrator S.O. Management"
        ElseIf My.Settings.Lco = "JUMP" Then
            Me.BackColor = Color.Maroon
            Me.Text = My.Settings.Lco & " S.O. Management"
