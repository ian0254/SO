...
Public Class FrmMTe
    ...
    Private Sub Me_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        ds.Tables("ds").Columns.Add("Term name")
    ...
    Private Sub Bw_DoWork(sender As Object, e As DoWorkEventArgs) Handles Bw.DoWork
        ...
        If slot > 0 Then
            Try
                With sqlcommand(slot)
                    If bwmode = 0 Then 'Load all available related data from the database.
                        .CommandText = ("SELECT COUNT(*) FROM tbl_terms")
                        Dim es = Convert.ToInt32(.ExecuteScalar)
                        Dim cnt As Integer = 0

                        .CommandText = ("SELECT ctrl_id, name FROM tbl_terms ORDER BY name ASC")
                        ...
                        If z = MsgBoxResult.Yes Then
                            ...
                            For i As Integer = 0 To delarra.Count - 1
                                ...
                                Else
                                    ...
                                    End With
                                    .CommandText = ("DELETE FROM tbl_terms WHERE ctrl_id=@id")
                                    .ExecuteNonQuery()
                                    cnt += 1
                                    Bw.ReportProgress((cnt * 100) / es)
                                End If
                            ...
                            For i As Integer = 0 To dr.Length - 1
                                ...
                                Else
                                    ...
                                    End With
                                    If dr(i)(2) = 0 Then
                                        .CommandText = ("INSERT INTO tbl_terms (name) VALUES (@val)")
                                        .ExecuteNonQuery()
                                    ElseIf dr(i)(2) = 2 Then
                                        .CommandText = ("UPDATE tbl_terms SET name=@val WHERE ctrl_id=@id")
                                        .ExecuteNonQuery()
                                    End If
                                    cnt += 1
                                    Bw.ReportProgress((cnt * 100) / es)
            ...
            Catch ex As Exception
                CloseConn(slot)
                If bwmode = 0 Then
                    NotifyMsgBox("r", "Terms name")
                ElseIf bwmode = 1 Then
                    NotifyMsgBox("s", "Terms name")
                End If
            End Try
        Else
            If bwmode = 0 Then
                NotifyMsgBox("pr", "Terms name")
            ElseIf bwmode = 1 Then
                NotifyMsgBox("ps", "Terms name")
            End If
        End If
    End Sub
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        If Button2.Text = "&Add" Then
            dr = ds.Tables("ds").Select("[Term name]='" & TxtCo.Text & "'")
            If dr.Length > 0 Then
